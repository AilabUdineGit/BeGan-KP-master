...
def model_opts(parser):
    ...
    """
    parser.add_argument('-train_discriminator', default=False, action="store_true", help=" Train Discriminator ")
...
def dis_opts(parser):
    ...
    parser.add_argument('-D_embedding_dim', type=int, default=200,
                        help=' embedding dim of Discriminators ')
    parser.add_argument('-pretrained_Discriminator', default=False, action="store_true")
    parser.add_argument('-Discriminator_model_path', type=str, default="model/%s.%s",
