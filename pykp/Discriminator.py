...
class Discriminator(nn.Module):
    def __init__(self, src_RNN, tgt_RNN, one2many, bos_idx, eos_idx, pad_idx, peos_idx, max_len, copy_attention,
                 review_attn, coverage_attn, epochs, device, embedding_dim):
